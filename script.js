...
const upadatePassIndicator = () => {
    ...
    passIndicator.id = lengthSlider.value <= 8 ? "weak" : lengthSlider.value <= 13 ? "medium1" : lengthSlider.value <= 19 ? "medium2" : lengthSlider.value <=26 ? "strong": lengthSlider.value <= 30 ? "verystrong" : "verystrong";
}
